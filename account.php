...
if (isset($_GET['action'])) {
	switch ($_GET['action']) {
		case 'getAccount':
			...
			$account = (new account())->getAccount($_GET['id']);
...
// if (count($_GET) == 0) {
	...
	// $html = "Charts go here";
	// echo $html;
// } elseif (isset($_GET['action']) && $_GET['action'] == 'getProject') {
		// $project = $inspire->getProject($_GET['pid']);
		// // '{{projects_count}}' => $account->urlCount,
